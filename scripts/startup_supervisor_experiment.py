...
from scb_ivr.startup_voltage_supervisor import StartupObservation, evaluate_startup_readiness


PROJECT_ROOT = Path(__file__).resolve().parents[1]
OUTPUT = PROJECT_ROOT / "outputs/diagnostics/R04E0_startup_supervisor_static.json"
