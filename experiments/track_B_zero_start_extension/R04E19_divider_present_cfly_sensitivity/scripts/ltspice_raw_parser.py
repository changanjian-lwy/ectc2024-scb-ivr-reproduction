...
(byte-for-byte identical logic) from R04E11/R04E12/R04E13's own committed
`scripts/ltspice_raw_parser.py`, reused here rather than re-derived, per
this project's own standing convention of not re-inventing an
already-verified raw-format parser. See those scripts' own docstring for
the original format-determination notes (LTspice 26.0.2 for MacOS,
